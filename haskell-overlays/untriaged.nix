...
in self: super: {
  ...
  commonmark = self.callHackage "commonmark" "0.2.1" {};
  commonmark-extensions = self.callHackage "commonmark-extensions" "0.2.1.2" {};
  commonmark-pandoc = self.callHackage "commonmark-pandoc" "0.2.1.1" {};
  ...
  texmath = self.callHackage "texmath" "0.12.3" {};
  rfc5051 = self.callHackage "rfc5051" "0.2" {};
  HsYAML = self.callHackage "HsYAML" "0.2.1.0" {};
  connection = self.callHackage "connection" "0.3.1" {};
  doclayout = self.callHackage "doclayout" "0.3.0.2" {};
  doctemplates = self.callHackage "doctemplates" "0.9" {};
  haddock-library = doJailbreak (self.callHackage "haddock-library" "1.10.0" {});
  hslua  = self.callHackage "hslua" "1.1.0" {};
  skylighting = self.callHackage "skylighting" "0.10.5.2" {};
  skylighting-core = self.callHackage "skylighting-core" "0.10.5.2" {};
